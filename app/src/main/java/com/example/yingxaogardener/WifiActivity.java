...
public class WifiActivity extends Activity {
    ...
    private com.example.yingxaogardener.DeviceAdapter adapter_devices;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backmain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(WifiActivity.this, StartActivity.class));
                finish();
            }
        });
    ...
    private void refreshDevices() {
        adapter_devices = new com.example.yingxaogardener.DeviceAdapter(this, R.layout.spinner_devices, new ArrayList<BluetoothDevice>());
